        ...
        <section className="hidden md:block">
          ...
          <div className="mt-8 space-y-3 text-sm text-zinc-400">
            <p className="flex items-start gap-2">
              ...
              <span>Works with YouTube, Twitch, X, Instagram, Vimeo, and local files</span>
            </p>
            <p className="flex items-start gap-2">
              <span className="mt-0.5 text-emerald-400">✓</span>
              <span>Frame-accurate trimming with lightning-fast exports</span>
            </p>
            <p className="flex items-start gap-2">
              <span className="mt-0.5 text-emerald-400">✓</span>
              <span>No free trial. Transparent monthly clip limits.</span>
            </p>
          </div>
        </section>
        ...
        <section className="flex justify-center md:justify-end">
          <div className="w-full max-w-md rounded-2xl border border-zinc-800 bg-zinc-900/80 p-6 shadow-xl">
            ...
            <h2 className="text-2xl font-semibold text-white mb-1">
              {isDesktopFlow ? "Link your desktop app" : "Welcome back"}
            </h2>
            <p className="text-sm text-zinc-400 mb-6">
              {isDesktopFlow ? "Sign in to link your account with the desktop app." : "Sign in to your account."}
            </p>
